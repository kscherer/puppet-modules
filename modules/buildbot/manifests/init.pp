...
class buildbot::slave {
  if $operatingsystem == 'CentOS' {
    yumrepo {
      'buildbot':
        baseurl => 'http://yow-mirror.ottawa.wrs.com/mirror/buildbot',
    ...
    exec {
      'create-buildbot-slave':
        ...
        command => 'buildslave create-slave slave yow-lpgbld-master.ottawa.windriver.com:9989 example-slave pass',
